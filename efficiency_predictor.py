...
def show_prediction():
    ...
    # st.title("Solar Efficiency Predictor")
    i=3

# Constants
OPTIMAL_EFFICIENCY_RANGE = (85, 92)
CRITICAL_DUST_DAYS = 3  # Threshold for urgent cleaning alert

# Data Generation (Cache for performance)
@st.cache_data
...
# Model Training (Cache to avoid reloading)
@st.cache_resource
def train_model():
...
# UI Configuration
st.set_page_config(
    page_title="Solar Efficiency Predictor Pro",
    page_icon="☀️",
    layout="centered"
)
